...
import com.example.mvc.services.OrderService;
...
//	        return "dashboard.jsp";
	        model.addAttribute("allOrders", orderServ.getAllOrders());
	        model.addAttribute("allRest",restServ.allRes());
	  ...
	  @RequestMapping("/admin")
	    public String adminPage(Principal principal, Model model) {
	        ...
	        model.addAttribute("currentUser", customerServ.findCustomerbyname(username));
	        model.addAttribute("allOrders", orderServ.getAllOrders());
	        System.out.println(orderServ.getAllOrders());
	        return "adminPage.jsp";
	    }
